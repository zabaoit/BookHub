        ...
        <div className="w-full max-w-md space-y-8 rounded-xl bg-white dark:bg-gray-900/50 p-8 shadow-sm">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button
              ...
              className="flex h-12 w-full items-center justify-center hover:cursor-pointer rounded-lg bg-primary text-base font-semibold text-white transition-colors hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed"
            >
