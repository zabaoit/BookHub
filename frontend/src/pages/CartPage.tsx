                ...
                <div className="sticky top-18">
                  <div className="bg-surface-light dark:bg-surface-dark border border-border-light dark:border-border-dark rounded-lg p-6">
                    ...
                    <div className="flex flex-col gap-3 mt-6">
                      ...
                      <button className="w-full bg-transparent hover:bg-primary/10 text-primary dark:text-accent font-bold py-3 px-4 rounded border border-primary dark:border-accent transition-colors">
                        Continue Shopping
                      </button>
                    </div>
                  </div>
