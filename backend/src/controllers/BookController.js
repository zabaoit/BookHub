...
const postBook = async (req, res) => {
    try {
        const {title, slug, description, isbn, publisher, publicationDate, pages, language, price, stock, author, images, categories} = req.body;
...
const getAllBooks = async (req, res) => {
    try {
        ...
        return res.status(200).json({message: 'Lấy danh sách sách thành công!', data: books});
    } catch (error) {
...
const getBookById = async (req, res) => {
    try {
        ...
        return res.status(200).json({message: 'Lấy thông tin sách thành công!', data: books});
    } catch (error) {
...
const updateBookById = async (req, res) => {
    try {
        ...
        return res.status(200).json({message: 'Cập nhật sách thành công!', data: books});
    } catch (error) {
